...
void idGameLocal::Clear( void ) {
	...
	spawnArgs.Clear();
	gravity.Set( 0, 0, -1 );
	playerPVS.h = (unsigned int)0; //-1;	// sikk - warning C4245: '=' : conversion from 'int' to 'unsigned int', signed/unsigned mismatch
	playerConnectedAreas.h = (unsigned int)0;//-1;	// sikk - warning C4245: '=' : conversion from 'int' to 'unsigned int', signed/unsigned mismatch
